...
var ChatService = /** @class */ (function () {
    ...
    ChatService.prototype.processMessage = function (message) {
        return __awaiter(this, void 0, Promise, function () {
            var lowercaseMessage, _i, predefinedQuestions_1, question;
            return __generator(this, function (_a) {
                console.log('Processing message:', message);
                lowercaseMessage = message.toLowerCase();
                for (_i = 0, predefinedQuestions_1 = predefined_questions_config_1.predefinedQuestions; _i < predefinedQuestions_1.length; _i++) {
                    question = predefinedQuestions_1[_i];
                    if (question.keywords.some(function (keyword) { return lowercaseMessage.includes(keyword); })) {
                        ...
                        return [2 /*return*/, { answer: question.answer, isAI: false }];
                    }
                }
                console.log('No match found, processing with AI');
                return [2 /*return*/, this.processAIMessage(message)];
            });
        });
    };
        ...
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.model.generateContent([message])];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, { answer: result.response.text(), isAI: true }];
                    case 2:
                        error_1 = _a.sent();
                        console.error('Error processing AI message:', error_1);
                        return [2 /*return*/, { answer: 'Xin lỗi, có lỗi xảy ra khi xử lý câu hỏi của bạn. Vui lòng thử lại sau.', isAI: false }];
