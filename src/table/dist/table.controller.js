...
var TableController = /** @class */ (function () {
    ...
    TableController.prototype.getAvailableTables = function (date, time) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                // Gọi service để kiểm tra các bàn trống
                return [2 /*return*/, this.tableService.getAvailableTables(date, time)];
            });
        });
    };
    __decorate([
    ...
    __decorate([
        common_1.Post('available'),
        __param(0, common_1.Body('date')),
        __param(1, common_1.Body('time'))
    ], TableController.prototype, "getAvailableTables");
