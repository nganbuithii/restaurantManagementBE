...
var InventoryController = /** @class */ (function () {
    ...
    InventoryController.prototype.testCheckInventoryLevels = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.inventoryService.checkInventoryLevels()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, { message: 'Inventory check initiated' }];
                }
            });
        });
    };
    ...
    __decorate([
        common_1.Post('test-check-inventory')
    ], InventoryController.prototype, "testCheckInventoryLevels");
