...
var CartController = /** @class */ (function () {
    ...
    CartController.prototype.getCart = function (user) {
    ...
    CartController.prototype.addToCart = function (user, addToCartDto) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.cartService.addToCart(user, addToCartDto)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    CartController.prototype.removeFromCart = function (user, itemId) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.cartService.removeFromCart(user, itemId)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
