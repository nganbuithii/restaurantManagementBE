...
var VouchersController = /** @class */ (function () {
    ...
    // }
    VouchersController.prototype.changeStatus = function (id, body, user) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.vouchersService.updateStatus(id, body.status, user)];
            });
        });
    };
    __decorate([
    ...
    __decorate([
        ...
        common_1.UseGuards(jwt_auth_guard_1.JwtAuthGuard),
        customize_1.ResponseMessage('Voucher status updated successfully'),
        __param(0, common_1.Param('id', common_1.ParseIntPipe)),
