...
var FeeckbacksController = /** @class */ (function () {
    ...
    FeeckbacksController.prototype.replyToFeedback = function (id, replyDto, user) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.s.replyToFeedback(id, replyDto, user)];
            });
        });
    };
    __decorate([
    ...
    __decorate([
        common_1.Post(':id/reply'),
        common_1.UseGuards(jwt_auth_guard_1.JwtAuthGuard),
        customize_1.ResponseMessage("Reply to feedback successfully"),
        __param(0, common_1.Param('id', common_1.ParseIntPipe)),
