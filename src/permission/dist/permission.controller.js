...
var PermissionController = /** @class */ (function () {
    ...
    PermissionController.prototype.create = function (createPermissionDto, user) {
        return this.permissionService.create(createPermissionDto);
    };
    PermissionController.prototype.getAll = function (params) {
        return this.permissionService.getAll(params);
    };
    PermissionController.prototype.getDetail = function (id) {
        return this.permissionService.getDetail(id);
    };
    PermissionController.prototype.update = function (id, data) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.permissionService.update(id, data)];
            });
        });
    };
    PermissionController.prototype.remove = function (id) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.permissionService.remove(id)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
