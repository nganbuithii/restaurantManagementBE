...
var PermissionsGuard = /** @class */ (function () {
    function PermissionsGuard(reflector, prismaService) {
        this.reflector = reflector;
        this.prismaService = prismaService;
    }
    PermissionsGuard.prototype.canActivate = function (context) {
        return __awaiter(this, void 0, Promise, function () {
            var requiredPermissions, request, user, userRole, userPermissions, hasPermission;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        requiredPermissions = this.reflector.get('permissions', context.getHandler());
                        if (!requiredPermissions) {
                            return [2 /*return*/, true]; // Không cần kiểm tra quyền nếu không có quyền được chỉ định
                        }
