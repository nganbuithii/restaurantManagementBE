...
-- CreateTable
CREATE TABLE `WarehouseSlipDetail` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `quantity` DOUBLE NOT NULL,
    `warehouseSlipId` INTEGER NOT NULL,
    `ingredientId` INTEGER NOT NULL,
...
CREATE TABLE `Inventory` (
    ...
    UNIQUE INDEX `Inventory_ingredientId_key`(`ingredientId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `FoodImage` ADD CONSTRAINT `FoodImage_menuItemId_fkey` FOREIGN KEY (`menuItemId`) REFERENCES `MenuItem`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `WarehouseSlip` ADD CONSTRAINT `WarehouseSlip_employeeId_fkey` FOREIGN KEY (`employeeId`) REFERENCES `Employee`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `WarehouseSlip` ADD CONSTRAINT `WarehouseSlip_supplierId_fkey` FOREIGN KEY (`supplierId`) REFERENCES `Supplier`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `WarehouseSlipDetail` ADD CONSTRAINT `WarehouseSlipDetail_warehouseSlipId_fkey` FOREIGN KEY (`warehouseSlipId`) REFERENCES `WarehouseSlip`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `WarehouseSlipDetail` ADD CONSTRAINT `WarehouseSlipDetail_ingredientId_fkey` FOREIGN KEY (`ingredientId`) REFERENCES `Ingredient`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
